            ...
            child: Column(
              children: [
                ...
                for (var d in widget.destinations)
                  // Wrapping ListTile widget inside Semantics widget to give attribute "flt-semantic-identifer" 
                  // that can be used as a XPATH locator in automation scripts
                  Semantics(
                    // Semantics class attribute that gives 
                    // 'flt-semantic-identifer' attribute to 'flt-semantic' tag
                    identifier: d.title,
                    child: ListTile(
                      leading: Icon(d.icon),
                      title: Text(d.title),
